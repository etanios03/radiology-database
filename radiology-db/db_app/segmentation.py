...
def load_dicom(dicom_path: str):
    ...
    # rescale the pixels into data we can use
    pixel_array = pixel_array * slope + intercept
    return ds, pixel_array

def segment_dicom(dicom_path: str) -> dict:
    ds, pixel_array = load_dicom(dicom_path)
    ...
    # everything above the threshold is the lesion, the rest is background
    mask = pixel_array > thresh
    # get the physical size of each threshold based on metadata 
    ...
    # make this into vol in mL based on the pixels volume
